...
def draw_bbox(image,bboxes,classes = read_class_names(cfg['yolo_classes_names']),show_label = True):
    ...
    for i,bbox in enumerate(bboxes):
        ...
        if show_label:
            ...
            t_size = cv2.getTextSize(bbox_mes,0,font_scale,thickness = bbox_thick // 2)[0]
            cv2.rectangle(image,coor1,(coor1[0] + t_size[0],coor1[1] - t_size[1] -3),bbox_color,-1)
            cv2.putText(image,bbox_mes,(coor1[0],coor1[1]-2),cv2.FONT_HERSHEY_SIMPLEX,font_scale,(0,0,0),
